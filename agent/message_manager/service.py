...
from agent.message_manager.views import MessageMetadata
...
from mobile.views import MobileState
...
class MessageManager:
	...
	def _init_messages(self) -> None:
		...
		self.add_tool_message(content='Mobile started')

		placeholder_message = HumanMessage(role='',content='[Your task history memory starts here]')
		self._add_message_with_tokens(placeholder_message)
	...
	def add_state_message(
		...
		"""Add mobile state as human message"""
	...
	def add_model_output(self, model_output: AgentOutput) -> None:
		...
		tool_calls = [
			{
				'name': 'AgentOutput',
				'args': model_output.dict(exclude_unset=True),
				'id': str(self.state.tool_id),
				'type': 'tool_call',
			}
		]
